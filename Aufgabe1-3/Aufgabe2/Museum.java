...
//The whole class represents OOP

/**
 * Represents a museum converted from an old house, showcasing historical living conditions.
 * Implements the Building interface, providing lifecycle, budget, and sustainability metrics.
 */
...
public class Museum implements Building {
    ...
    private double energyConsumption = random.nextInt(20000, 30000);
    ...
    /**
     * Initializes a Museum object with a specific type of building.
     * @param kind Type of building influencing its properties.
     * PRE: kind != null
     * POST: A new Museum object is created with initialized materials and stats.
     */
    public Museum(KindOfBuilding kind) {
        this.kind = kind;
        shellMaterial = new ShellMaterial(kind.getShellMaterialCoeff(), random.nextInt(70, 100));
        finishMaterial = new FinishMaterial(kind.getFinishMaterialCoeff(), random.nextInt(5, 10));
     ...
     * POST: Result > 0
     */
    // GOOD OOP: polymorphism where different types of buildings (MinimalKindOfBuilding, EcologicalKindOfBuilding)
    // affect how the sustainability index is calculated.
    ...
    /**
     * Retrieves the renovation cycle of the museum.
    ...
    /**
     * Checks whether the museum is destroyed.
    ...
    /**
     * Retrieves the current age of the museum.
     * @return Age in years.
     * POST: Result >= 0
     */
    @Override
