package Aufgabe7;
@Documentation(description = "A class representing a small-sized underfloor heating office.",
        responsible = "Simeon Obretenov",
        invariants = {"The size of the office must always be '1'.",
                "The name of the office must always be non-null and non-empty.",
                "The assigned pump, if any, must be compatible with small underfloor heating offices."},
...
public class SmallUnderfloorOffice extends UnderfloorHeatingOffice {

    @Documentation(description = "Constructor to create a SmallUnderfloorOffice instance with a specified name.",
            responsible = "Simeon Obretenov",
            preconditions = {"The name must not be null or empty."},
            postconditions = {"A small-sized underfloor office instance is created with the specified name and the size set to '1'."})
    public SmallUnderfloorOffice(String n) {
        super(n, 1);
    }
