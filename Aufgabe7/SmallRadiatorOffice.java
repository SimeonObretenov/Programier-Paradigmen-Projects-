package Aufgabe7;
@Documentation(description = "A class representing a small-sized radiator heating office.",
        ...
        "The assigned pump, if any, must be compatible with small radiator heating offices."},
...
public class SmallRadiatorOffice extends RadiatorHeatingOffice {
    @Documentation(description = "Constructor to create a SmallRadiatorOffice instance with a specified name.",
            responsible = "Simeon Obretenov",
            preconditions = {"The name must not be null or empty."},
            postconditions = {"A small-sized radiator office instance is created with the specified name and the size set to '1'."})
    public SmallRadiatorOffice(String n) {
        super(n, 1);
    }
